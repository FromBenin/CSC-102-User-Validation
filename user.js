...
function VALIDATION() {
    ...
    if ((zipCode === "") || (zipCode > 99999) || (zipCode < 10000) || (zipCode < 9999) || (zipCode < 999) || (zipCode < 99)) {
    ...
    if ((fullName.length <= 20) && (fullName.length >= 10) && (zipCode < 99999) && (zipCode > 9999) && (zipCode > 999) && (zipCode > 99)) {
